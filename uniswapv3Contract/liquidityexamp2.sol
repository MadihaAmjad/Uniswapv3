...
address constant DAI = 0xb27A31f1b0AF2946B7F582768f03239b1eC07c2c;
address constant WETH = 0xDA07165D4f7c84EEEfa7a4Ff439e039B7925d3dF;
...
contract UniswapV3Liquidity is IERC721Receiver {
    ...
    event test(uint256, uint128,uint256,uint256);
    ...
    INonfungiblePositionManager public nonfungiblePositionManager =
        INonfungiblePositionManager(0x358AA13c52544ECCEF6B0ADD0f801012ADAD5eE3);
        ...
        )
    {
        ...
        (tokenId, liquidity, amount0, amount1) =
            ...
            emit test(tokenId, liquidity, amount0, amount1);
